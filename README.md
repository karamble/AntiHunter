...
> [!NOTE]
> **Halberd** is the MIT-licensed continuation of [`lukeswitz/AntiHunter`](https://github.com/lukeswitz/AntiHunter). The project was renamed from `karamble/AntiHunter` to `karamble/halberd` in 2026-05. Old URLs redirect.
>
